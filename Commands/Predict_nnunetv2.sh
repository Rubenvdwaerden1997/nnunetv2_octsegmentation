...
python3 -u nnunetv2/inference/predict_from_raw_data.py \
    -i /data/diag/rubenvdw/nnunetv2/nnUNet/nnunetv2/Data/nnUNet_raw/Dataset501/imagesTs \
    -o /data/diag/rubenvdw/nnunetv2/nnUNet/nnunetv2/Predictions/Dataset501/Predicted_files \
    -d 501 \
    -c 2d \
    --save_probabilities \
    -f 0