...
def main():
    target_base = 'Z:/rubenvdw/nnU-net/data-2d/nnUNet_raw_data/Task921_SegmentOCT_11_3D3'
    target_imagesTr = 'Z:/rubenvdw/nnU-net/data-2d/nnUNet_raw_data/Task921_SegmentOCT_11_3D3/imagesTr'
    target_imagesTs = 'Z:/rubenvdw/nnU-net/data-2d/nnUNet_raw_data/Task921_SegmentOCT_11_3D3/imagesTs'
    task_name = 'Task921_SegmentOCT_11_3D3'
    dataset_description = 'Semantic segmentation of intracoronary OCT pullbacks pseudo-3D (k=3) with 11 classes, extra frames 08032024'
    modalities = ('R', 'G', 'B')
    ...
    generate_dataset_json(join(target_base, 'dataset.json'), target_imagesTr, target_imagesTs, modalities=modalities, dataset_description=dataset_description,
                        labels={0:'background', 1:'lumen', 2:'guidewire', 3:'intima', 4:'lipid', 5:'calcium', 
                        6:'media', 7:'catheter', 8: 'sidebranch', 9:'thrombus', 10:'rupture',11:'ignore'}, 
                        dataset_name=task_name, license='hands off!')
