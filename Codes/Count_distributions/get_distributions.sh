...
python3 -u /data/diag/rubenvdw/nnunetv2/nnUNet/nnunetv2/Codes/Count_distributions/get_distributions_multiprocessing.py \
    ...
    --output_filename /data/diag/rubenvdw/nnunetv2/nnUNet/nnunetv2/Predictions/Dataset701_TS3D3/Metrics/Counts_total_dataset \
    --data_info /data/diag/rubenvdw/Info_files_Dataset_split/15_classes_dataset_split_extraframes_25102024 \
    --num_classes 14 \
    --lipid_cap_area_manual 0 \
    --task_name Dataset701_TS3D3
